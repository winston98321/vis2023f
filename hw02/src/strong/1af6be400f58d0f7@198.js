...
__query(FileAttachment("data.json"),{from:{table:"data"},sort:[],slice:{to:null,from:null},filter:[],select:{columns:null}},invalidation)
)}
...
function _7(yCounts,Constellation,data)
{
...
function _9(Plot,plot2,Constellationmap,yCounts){return(
Plot.plot({
  marginTop: plot2.mt,
  ...
  marks: [  
    Plot.ruleY([0]),
		Plot.barY(yCounts, {y:"count",  x:"Constellation",  fill:"Gender", 
              title: (d,i) => `Constellation: ${Constellationmap[i]},\n Gender: ${d.gender},\n count: ${d.count}:`, tip: true,fill:"gender"}),  
	 ],
  
})
)}

function _10(Plot,data,Constellationmap){return(
Plot.plot({
  width:1000,
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["yCounts","Constellation","data"], _7);
  ...
  main.variable(observer()).define(["Plot","plot2","Constellationmap","yCounts"], _9);
  main.variable(observer()).define(["Plot","data","Constellationmap"], _10);
  return main;
}
